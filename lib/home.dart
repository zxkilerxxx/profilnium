...
class _FragmentHome extends State<FragmentHome> {
  ...
  Future<List<Document>> getPenjualanHariIni() async {
    List<Document> doc = await Firestore.instance
        .collection('invoice')
        .where("Tanggal",
  ...
  void fetchDataForCurrentMonth() async {
    ...
    List<Document> documents =
        await Firestore.instance.collection('invoice').get();
                            ...
                            children: [
                              ...
                              Text('Bulan Ini',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 10),
                              Text(resultMonth.length.toString(),
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 0, 128, 255),
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20)),
                            ...
                            children: [
                              ...
                              Text('Bulan Ini',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 10),
                              Text(grandTotalThisMonth.toString(),
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 0, 128, 255),
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20)),
                            ...
                            children: [
                              ...
                              Text('Tahun Ini',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 10),
                              Text(grandTotalThisYear.toString(),
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 0, 128, 255),
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20)),
